        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
          ...
          >
            ...
            <div className="mb-8">
              ...
              <h2 className="text-3xl font-display font-bold mb-2">{t('auth.join_title')}</h2>
              <p className="text-stone-500">{t('auth.join_desc')}</p>
            </div>

            {step === 'INPUT' ? (
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <label className="block text-sm font-bold text-stone-700 mb-2">{t('auth.email_label')}</label>
                ...
                >
                  {t('auth.send_link')} <ArrowRight size={18} />
                </button>
              </form>
            ) : (
              <div className="py-12 text-center space-y-4">
                ...
                <h3 className="text-xl font-bold">{t('auth.link_sent')}</h3>
                <p className="text-stone-500">{t('auth.link_sent_desc')}</p>
